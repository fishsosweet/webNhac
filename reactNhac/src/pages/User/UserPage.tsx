...
// ];
import {getDSBaiRandom} from "../../services/User/TrangChuService.tsx";
        ...
        ${isLoading ? 'bg-gray-400' : 'bg-purple-500 hover:bg-purple-600'} text-white transition`}
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    {baiHatRandom.map((item) => (
                        <div key={item.id} className="flex items-center gap-6 hover:bg-[#2a213a] p-2 rounded-md transition duration-300">
                                <img
